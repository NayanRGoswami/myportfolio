...
import '../../Style/Mobile/Mobileskills.css';
import Mobilenav from "./Mobilenav";
import {Link} from "react-router-dom";
import Tobar from "./Tobar";


class Mobileskills extends React.Component {
        ...
        return (
            <div>
              ...
              <div className= "mobileskills">
                  ...
                  <h4 className= "skills-title text-danger"><i className="laptop icon"></i> FRONT-END WEB DEVELOPMENT</h4>
                  ...
                  <h4 className= "skills-title text-danger"><i className="code icon"></i> BACK-END WEB DEVELOPMENT</h4>
                  ...
                  <h4 className= "skills-title text-danger"><i className="suitcase icon"></i> SOME MORE SKILLS TO OFFER</h4>
